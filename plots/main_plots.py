...
df["TimeExecute"] = df["TimeKruskal"] + df["TimeInsertion"]
...
plt.savefig("./resultados/all_graphs.png")
...
for edge_extractor in ["ArraySort", "HeapMin"]:
    ...
    plt.savefig(f"./resultados/plot_{edge_extractor}.png")
...
for opti_path  in [True, False]:
    ...
    plt.savefig(f"./resultados/plot_opti_{opti_path}.png")
